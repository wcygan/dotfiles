...
```bash
./.codex/skills/cross-platform-guardian/scripts/audit-compatibility.sh
```
...
```bash
./.codex/skills/cross-platform-guardian/scripts/test-platform-compatibility.sh
```
...
```
.codex/skills/cross-platform-guardian/
...
```bash
#!/usr/bin/env bash
./.codex/skills/cross-platform-guardian/scripts/audit-compatibility.sh || exit 1
```
...
Edit `.codex/skills/cross-platform-guardian/scripts/audit-compatibility.sh` to refine detection logic.
...
- **Main skill**: `SKILL.md` (loaded by Codex when activated)
- **Technical details**: `REFERENCE.md` (comprehensive guide)
- **Repository docs**: `AGENTS.md` (workflow and standards)
- **User preferences**: `~/.codex/AGENTS.md` (personal dev methodology)

---

**Maintained by**: Cross-platform compatibility skill (auto-invoked by Codex)
