...
help:
	...
	@echo "  make agent-skills            - Install the pinned shared Codex user skill catalog"
	@echo "  make agent-skills-check      - Verify the pinned shared Codex user skill catalog"
