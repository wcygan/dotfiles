...
description: Four ready-to-use SKILL.md templates for code analysis, test generation, documentation, and data processing — adapted for global skills
tags: [templates, code-analysis, test-generation, documentation, data-processing]
---

# Skill Templates

Four templates to use as starting points. These are global skills — avoid hard-coding
