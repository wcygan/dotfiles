...
description: AskUserQuestion workflow for gathering skill creation requirements
tags: [requirements, wizard, questions]
---

# Requirements Wizard

Use the AskUserQuestion tool to ask these three questions before creating any skill files.
Invoke all three questions in a single AskUserQuestion call.
...
2. Select matching template from skill-templates.md
3. If "Restricted" was chosen, apply allowed-tools from file-structure-and-tools.md
4. If "Advanced" was chosen, plan reference files alongside SKILL.md
5. Proceed to file creation only after all three answers are collected
