...
Source index: https://effect.website/llms.txt

Use this file to choose which official page to fetch. Do not treat it as an API snapshot; fetch the current page before relying on signatures, examples, or recommendations.

## Core Runtime And App Structure
...
## Caching, Batching, And Scheduling
...
- [Introduction to Sink](https://effect.website/docs/sink/introduction/)
...
- [API List](https://tim-smart.github.io/effect-io-ai/)
