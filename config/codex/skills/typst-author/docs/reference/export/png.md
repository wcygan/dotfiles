...
transparent using `[#set page(fill: none)]`. Learn more on the `page`
...
- `[{0p}]`, which will be replaced by the zero-padded page number (so
  that all numbers have the same length)
