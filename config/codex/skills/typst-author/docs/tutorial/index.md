...
1.  Writing in Typst: Learn how to write text and insert images,
    equations, and other elements.

2.  Formatting: Learn how to adjust the formatting of your document,
    including font size, heading styles, and more.

3.  Advanced Styling: Create a complex page layout for a scientific
    paper with typographic features such as an author list and run-in
    headings.

4.  Making a Template: Build a reusable template from the paper you
    created in the previous chapter.

We hope you'll enjoy Typst!

- [1-writing.md](1-writing.md)

- [2-formatting.md](2-formatting.md)

- [3-advanced.md](3-advanced.md)

- [4-template.md](4-template.md)
