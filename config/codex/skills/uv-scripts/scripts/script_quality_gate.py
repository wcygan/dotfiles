...
Run:
    uv run --script script_quality_gate.py config/codex/skills/uv-scripts/scripts
    uv run --script script_quality_gate.py config/codex/skills/uv-scripts/scripts --run-help --ruff
"""
